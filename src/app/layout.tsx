...
export const metadata: Metadata = {
  ...
  keywords: "luxury hotel, 5-star accommodation, premium rooms, spa wellness, fine dining, concierge service, city hotel",
  ...
  openGraph: {
    title: "Grand Luxe Hotel - 5-Star Luxury Accommodations",
    description: "Experience unparalleled luxury at Grand Luxe Hotel with premium rooms and world-class amenities.",
